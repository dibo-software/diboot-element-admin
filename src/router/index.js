...
const generateRouterMap = [
  {
    path: '/workorder',
    redirect: '/workorder/demo/list',
    component: Layout,
    alwaysShow: true,
    name: 'workorder',
    meta: { title: '工单管理', icon: 'null', permission: ['workorder'] },
    children: [
      {
        path: 'categoryWorkorderList/index',
        name: 'categoryWorkorderListIndex',
        component: () => import('@/views/workorder/categoryWorkorderList/index'),
        meta: { title: '分类工单查看', keepAlive: true }
      },

      {
        path: 'workorderStatics/index',
        name: 'workorderStaticsIndex',
        component: () => import('@/views/workorder/workorderStatics/index'),
        meta: { title: '工单统计图表', keepAlive: true }
      },
      {
        path: 'mtCategory/list',
        name: 'mtCategoryList',
        component: () => import('@/views/workorder/mtCategory/list'),
        meta: { title: '分类管理', keepAlive: true, permission: ['MtCategory'] }
      },
      {
        path: 'demo/list',
        name: 'demoList',
        component: () => import('@/views/workorder/demo/list'),
        meta: { title: '示例管理', keepAlive: true, permission: ['Demo'] }
      }
  ...
  {
    path: '/chart_test',
    redirect: '/chart_test/mtWorkorder/list',
    component: Layout,
    alwaysShow: true,
    name: 'chart_test',
    meta: { title: '统计图测试', icon: 'null', permission: ['chart_test'] },
    children: [

      {
        path: 'mtWorkorder/list',
        name: 'mtWorkorderList',
        component: () => import('@/views/chart_test/mtWorkorder/list'),
        meta: { title: '工单管理', keepAlive: true, permission: ['MtWorkorder'] }
      }
